...
export default async function ExternalFormPage({
  ...
  console.log("[v0] External form server - Loading data for org:", params.organization, "template:", params.id)
      ...
      return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">The organization "{params.organization}" could not be found.</p>
          </div>
        </div>
      )
    }
