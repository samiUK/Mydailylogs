...
export default async function AdminHistoryPage() {
  ...
  try {
    ...
    console.log("[v0] Admin History page - Supabase client created")

    const {
      data: { user },
    } = await supabase.auth.getUser()

    console.log("[v0] Admin History page - User ID:", user?.id)
    ...
    console.log("[v0] Admin History page - Profile data:", profile)
