  ...
  const generatePDF = (submission: any, responses: any[]) => {
    ...
    const html = `
      ...
      <html>
        ...
        <body>
          <!-- Updated to use organization-specific branding instead of Daily Brand Check -->
          <div class="company-header">
            <div class="company-logo">
              ${organization?.logo_url ? `<img src="${organization.logo_url}" alt="${organization.name || "Organization"} Logo" />` : organization?.name ? organization.name.substring(0, 3).toUpperCase() : "ORG"}
            </div>
            <h1 class="company-name">${organization?.name || "Your Organization"}</h1>
            <p class="company-tagline">Professional Compliance & Quality Assurance</p>
          </div>
          
          <!-- Enhanced report header with better styling and metadata layout -->
          ...
          <!-- Updated footer to be organization-neutral -->
          <div class="footer">
            <p>This report was generated by your organization's compliance system.</p>
                          ...
                          <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                            ...
                            <div className="mt-4 border rounded-lg bg-white">
                              <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-6 rounded-t-lg text-center">
                                ...
                                <h2 className="text-xl font-bold mb-1">{organization?.name || "Your Organization"}</h2>
