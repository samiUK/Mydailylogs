...
export default function ReportsPage() {
  ...
  const generatePDF = (submission: any, responses: any[]) => {
    ...
    const displayName = hasCustomBranding ? organization?.name || "Your Organization" : "Daily Brand Check"
    ...
    const html = `
      ...
      <html>
        ...
        <body>
          ...
          <div class="footer">
            <p>This report was generated by ${hasCustomBranding ? "your organization's" : "Daily Brand Check"} compliance system.</p>
                              ...
                              <div className="p-6">
                                ...
                                <div className="mt-8 pt-4 border-t-2 border-indigo-500 text-center text-gray-600 text-sm">
                                  <p>
                                    ...
                                    {hasCustomBranding ? "your organization's" : "Daily Brand Check"} compliance system.
                                  </p>
                                  <p>For questions or support, please contact your system administrator.</p>
                                  {!hasCustomBranding && (
