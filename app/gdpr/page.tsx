      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-4xl mx-auto mb-12">
          ...
          <ol>
            ...
            <li><strong>Integrity and confidentiality:</strong> We protect your data with appropriate security measures</li>
          </ol>
        ...
        <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-8 mb-12">
          ...
          <div className="bg-white p-4 rounded-lg mb-4">
            <p className="mb-1"><strong>Email:</strong> info@mydaylogs.co.uk</p>
            <p><strong>Company:</strong> MyDayLogs Ltd, United Kingdom</p>
          </div>
          <p className="text-gray-700 mb-4">
        ...
        <div className="bg-gray-50 p-8 rounded-lg">
          ...
          <div className="bg-white p-6 rounded-lg">
            ...
            <p className="mb-1">Website: <a href="https://ico.org.uk" className="text-emerald-600 hover:text-emerald-700">https://ico.org.uk</a></p>
