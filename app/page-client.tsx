...
export default function HomePageClient() {
  ...
  useEffect(() => {
    const detectCurrency = () => {
      try {
        // Detect timezone and set currency accordingly
        ...
        // Default to GBP for other regions
        else {
          setCurrency("GBP")
        }
      } catch (error) {
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
            ...
            the go. Complete checklists, capture evidence, and generate professional reports - perfect for construction,
