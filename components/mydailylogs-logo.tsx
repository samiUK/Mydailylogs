    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className={`${sizeClasses[size]} flex-shrink-0`}>
        <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          {/* Background Circle */}
          <circle cx="20" cy="20" r="18" fill="#10b981" className="drop-shadow-sm" />

          {/* Calendar/Log Icon */}
          <rect x="10" y="12" width="20" height="16" rx="2" fill="white" opacity="0.95" />

          {/* Calendar Header */}
          <rect x="10" y="12" width="20" height="4" rx="2" fill="#059669" />

          {/* Checkmark Lines */}
          <rect x="13" y="19" width="8" height="1.5" rx="0.75" fill="#10b981" />
          <rect x="13" y="22" width="6" height="1.5" rx="0.75" fill="#10b981" />
          <rect x="13" y="25" width="10" height="1.5" rx="0.75" fill="#10b981" />
